		...
		<div className="  w-full bg-white min-h-[calc(100vh-80px)] lg:flex  lg:flex-row  gap-4 p-6 mx-auto">
			...
			<div className=" h-[80vh] w-full mt-5 flex flex-col justify-start items-start">
				<div className="add-and-search-buttons flex justify-between items-center w-full ">
					...
					<div className="hidden md:flex  bg-tertialy w-82 h-12 rounded-t-xl  md:justify-start md:items-center gap-4 focus-within:border-3 border-secondry   xl:h-15 xl:w-85 px-3">
						<input
					...
					<div className="add-btn flex justify-center items-center w-17 h-12 rounded-t-xl text-white bg-tertialy hover:bg-secondry hover:text-white hover:cursor-pointer px-3 xl:justify-between xl:w-74 xl:h-15 xl:rounded-t-xl lg:justify-center lg:items-center ">
