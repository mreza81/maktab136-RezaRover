...
function Homeinfo() {
	return (
		<div className="w-screen  relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-gray-200">
				...
				<div className="hc-bottom mt-15 grid grid-cols-1 lg:grid-cols-2 gap-y-5 ">
					<div className="bg-white rounded-xl shadow-md p-8 text-center  w-1/2 md:min-w-[500px] xl:w-[600px]  mx-auto">
						...
						<p className="text-gray-600 leading-7 text-sm hidden md:block">
							شرکت رضاروور با ارائه خدمات فروش اقساطی، این امکان را برای مشتریان
							فراهم می‌کند تا خودروی مورد نظر خود را بدون پرداخت نقدی کامل
							خریداری کنند.
						</p>
					</div>
					<div className=" rounded-xl bg-white shadow-md p-8 text-center w-1/2 md:w-[500px] xl:w-[600px]  mx-auto">
						...
						{/* text */}
						<p className="text-gray-600 leading-7 text-sm hidden md:block">
							رضاروور به شما این امکان را می‌دهد که بدون نیاز به انتظار طولانی،
							خودرو را در زمان تعیین شده دریافت کنید و از تجربه خریدی سریع و
							راحت لذت ببرید.
						</p>
					</div>
					<div className="bg-white rounded-xl shadow-md p-8 text-center  w-1/2 md:w-[500px] xl:w-[600px]  mx-auto">
						...
						{/* text */}
						<p className="text-gray-600 leading-7 text-sm hidden md:block">
							شرکت رضاروور با واردات مستقیم خودرو از تولیدکنندگان معتبر، محصولات
